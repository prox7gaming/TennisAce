...
define config.name = _("Tennis Ace")
...
define build.name = "Tennis Ace"
define build.directory_name = "TennisAce0.34"
...
define config.main_menu_music = "music/BGM/Two Together.ogg"
...
define config.save_directory = "TennisAce-1499236432"
...
init python:
    ...
    # Put images into the media archive.
